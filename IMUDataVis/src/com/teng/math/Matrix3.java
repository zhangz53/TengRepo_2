...
public class Matrix3 {
	...
	public Matrix3 SetToRotation (Vector3 axis, double degrees) {
		return SetToRotation(axis, MathUtils.cosDeg(degrees), MathUtils.sinDeg(degrees));
	}

	public Matrix3 SetToRotation (Vector3 axis, double cos, double sin) {
		double oc = 1.0f - cos;
	 ...
	 * @return This matrix for the purpose of chaining operations. */
	public Matrix3 SetToScaling (double scaleX, double scaleY) {
		val[M00] = scaleX;
		val[M10] = 0;
		val[M20] = 0;
		val[M01] = 0;
	 ...
	 * @return This matrix for the purpose of chaining. */
	public Matrix3 Scale (double ScaleX, double ScaleY) {
		tmp[M00] = ScaleX;
		tmp[M10] = 0;
		tmp[M20] = 0;
		tmp[M01] = 0;
	 ...
	 * @return This matrix for the purpose of chaining methods together. */
	public Matrix3 Scl (double Scale) {
		val[M00] *= Scale;
		val[M11] *= Scale;
		return this;
	}
