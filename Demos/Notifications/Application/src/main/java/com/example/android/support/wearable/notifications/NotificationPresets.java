...
public class NotificationPresets {
    ...
    public static final NotificationPreset Timer = new TimerNotificationPreset();
    public static final NotificationPreset Calorie_1 = new Calorie1NotificationPreset();
    public static final NotificationPreset Calorie_2 = new Calorie2NotificationPreset();
    public static final NotificationPreset Office = new OfficeNotificationPreset();
    ...
    private static class BigPictureNotificationPreset extends NotificationPreset {
        ...
        public Notification[] buildNotifications(Context context, BuildOptions options) {
            ...
            style.setBigContentTitle(context.getString(R.string.timer_style_title));
            style.setSummaryText(context.getString(
                    R.string.timer_style_summary_text));
    ...
    //timer
    private static class TimerNotificationPreset extends NotificationPreset {
        public TimerNotificationPreset() {
            super(R.string.timer_example, R.string.timer_title,
                    R.string.timer_content);
        }
    ...
    //calorie 1
    private static class Calorie1NotificationPreset extends NotificationPreset {
        public Calorie1NotificationPreset() {
            super(R.string.calorie_1_example, R.string.calorie_1_title,
                    R.string.calorie_1_content);
        }
        ...
        public Notification[] buildNotifications(Context context, BuildOptions options) {
            NotificationCompat.BigPictureStyle style = new NotificationCompat.BigPictureStyle();
            style.bigPicture(BitmapFactory.decodeResource(context.getResources(),
                    R.drawable.example_meat));
            style.setBigContentTitle(context.getString(R.string.calorie_1_style_title));
            style.setSummaryText(context.getString(
                    R.string.calorie_1_style_summary_text));
    ...
    //calorie 2
    private static class Calorie2NotificationPreset extends NotificationPreset {
        public Calorie2NotificationPreset() {
            super(R.string.calorie_2_example, R.string.calorie_2_title,
                    R.string.calorie_2_content);
        }
        ...
        public Notification[] buildNotifications(Context context, BuildOptions options) {
            NotificationCompat.BigPictureStyle style = new NotificationCompat.BigPictureStyle();
            style.bigPicture(BitmapFactory.decodeResource(context.getResources(),
                    R.drawable.example_vegetable));
            style.setBigContentTitle(context.getString(R.string.calorie_2_style_title));
            style.setSummaryText(context.getString(
                    R.string.calorie_2_style_summary_text));
    ...
    //office
    private static class OfficeNotificationPreset extends NotificationPreset {
        public OfficeNotificationPreset() {
            super(R.string.office_example, R.string.office_title,
                    R.string.office_content);
        }
        ...
        public Notification[] buildNotifications(Context context, BuildOptions options) {
            NotificationCompat.BigPictureStyle style = new NotificationCompat.BigPictureStyle();
            style.bigPicture(BitmapFactory.decodeResource(context.getResources(),
                    R.drawable.example_conference));
            style.setBigContentTitle(context.getString(R.string.office_style_title));
            style.setSummaryText(context.getString(
                    R.string.office_style_summary_text));
