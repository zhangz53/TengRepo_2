...
namespace RingPad.Scripts
{
  ...
  public class PhidgetsPosTest : MonoBehaviour
  {
    ...
    private StreamWriter accelAfterFilter;
    private StreamWriter accelBeforeFilter;
    private StreamWriter velocityBeforeFilter;
    private StreamWriter velocityAfterFilter;
    private StreamWriter position;
    ...
    void Update()
    {
      ...
      if (phidgetsAttached)
      {
        ...
        Target.transform.localRotation = MatrixToQuaternion(mMatrix[0,0],mMatrix[0,1],mMatrix[0,2],mMatrix[1,0],mMatrix[1,1],mMatrix[1,2],mMatrix[2,0],mMatrix[2,1],mMatrix[2,2]);
    ...
    {
      double xs = q.x * 2f, ys = q.y * 2f, zs = q.z * 2f;
      ...
      Row0 = new Vector4((float)m00, (float)m01, (float)m02, (float)m03);
      Row1 = new Vector4((float)m10, (float)m11, (float)m12, (float)m13);
      Row2 = new Vector4((float)m20, (float)m21, (float)m22, (float)m23);
      Row3 = new Vector4((float)m30, (float)m31, (float)m32, (float)m33);
      ...
      //print(retMatrix[0, 0] + ", " + retMatrix[0, 1] + ", " + retMatrix[0, 2] + ", " + retMatrix[0, 3] + ", ");
      //print(retMatrix[1, 0] + ", " + retMatrix[1, 1] + ", " + retMatrix[1, 2] + ", " + retMatrix[1, 3] + ", ");
      //print(retMatrix[1, 0] + ", " + retMatrix[2, 1] + ", " + retMatrix[2, 2] + ", " + retMatrix[2, 3] + ", ");
      //print(retMatrix[1, 0] + ", " + retMatrix[3, 1] + ", " + retMatrix[3, 2] + ", " + retMatrix[3, 3] + ", ");
