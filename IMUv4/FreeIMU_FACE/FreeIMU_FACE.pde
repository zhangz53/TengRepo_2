...
PFont font;
final int VIEW_SIZE_X = 1280, VIEW_SIZE_Y = 720;
...
void setup() 
{
   ...
   size(VIEW_SIZE_X, VIEW_SIZE_Y, P3D);
    frameRate(30);
    //model = new OBJModel(this, "head.obj", POLYGON);
    model = new OBJModel(this, "Face.obj", POLYGON);
    model.disableDebug();

//FOR: head.obj, no texture
/*
    model.scale(12);
